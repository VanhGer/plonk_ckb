...
impl Circuit {
    ...
    fn add_gate(&mut self, a: (usize, usize, Fr), b: (usize, usize, Fr), c: (usize, usize, Fr), gate_type: GateType, pi: Fr) {
    ...
    pub fn add_addition_gate(&mut self, a: (usize, usize, Fr), b: (usize, usize, Fr), c: (usize, usize, Fr), pi: Fr) {
        self.add_gate(a, b, c, GateType::Addition, pi);
    }

    /// Adds a multiplication gate to the circuit.
    pub fn add_multiplication_gate(&mut self, a: (usize, usize, Fr), b: (usize, usize, Fr), c: (usize, usize, Fr), pi: Fr) {
        self.add_gate(a, b, c, GateType::Multiplication, pi);
    }

    /// Adds a constant gate to the circuit.
    pub fn add_constant_gate(&mut self, a: (usize, usize, Fr), b: (usize, usize, Fr), c: (usize, usize, Fr), pi: Fr) {
    ...
    pub fn compile(mut self) -> Result<CompiledCircuit, String> {
        ...
        Ok(CompiledCircuit::new(gate_constraints, copy_constraints, circuit_size))
    }
